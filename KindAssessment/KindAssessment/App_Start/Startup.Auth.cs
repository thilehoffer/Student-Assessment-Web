...
namespace AssessmentApp.WebClient
{
    public partial class Startup
    {
        ...
        private bool MakeSureRolesExist(Models.AppIdentityDbContext context)
        {
            IdentityResult ir;
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            //Added this to make sure the teach roles exists
            MakeSureRolesExist(AppIdentityDbContext.Create());
