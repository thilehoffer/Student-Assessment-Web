        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    UserManager.AddToRole(user.Id, Enums.SecurityRoles.Teacher.ToString().ToLower());
                    ...
                    SessionItems.TeacherId = DataRepository.CreateTeacher(new Data.Models.Teacher { UserId = user.Id }).Id;
